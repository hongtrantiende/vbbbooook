...
public final class lo7 {
    public static final ko7 Companion = new Object();
    public final long a;
    ...
    public /* synthetic */ lo7(int i, long j, String str, String str2, String str3, int i2, float f, long j2) {
        if ((i & 1) == 0) {
            this.a = 0L;
        } else {
            this.a = j;
    ...
    public final boolean equals(Object obj) {
        ...
        lo7 lo7Var = (lo7) obj;
        if (this.a == lo7Var.a && sl5.h(this.b, lo7Var.b) && sl5.h(this.c, lo7Var.c) && sl5.h(this.d, lo7Var.d) && this.e == lo7Var.e && Float.compare(this.f, lo7Var.f) == 0 && this.g == lo7Var.g) {
            return true;
        }
        return false;
    }
