...
public final class kf0 {
    public static final int[] a = qtd.j("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=");

    static {
        qtd.j("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_=");
    }
    ...
    public static byte[] a(String str) {
        ...
        int i5;
        int i6 = 0;
        String P = sba.P(sba.P(sba.P(sba.P(str, false, " ", ""), false, "\n", ""), false, "\r", ""), false, "\t", "");
        int length = P.length();
        byte[] bArr = new byte[length];
        for (int i7 = 0; i7 < length; i7++) {
            bArr[i7] = (byte) P.charAt(i7);
        }
