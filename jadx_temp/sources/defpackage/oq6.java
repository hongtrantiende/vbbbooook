...
public abstract class oq6 {
    ...
    public static void b(StringBuilder sb, int i, String str, Object obj) {
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                sb.append(": \"");
                oy0 oy0Var = oy0.c;
                sb.append(e52.l(new oy0(((String) obj).getBytes(mk5.a))));
                sb.append('\"');
            } else if (obj instanceof oy0) {
                sb.append(": \"");
                sb.append(e52.l((oy0) obj));
                sb.append('\"');
    ...
    */
    public static void c(defpackage.sl4 r21, java.lang.StringBuilder r22, int r23) {
        /*
            Method dump skipped, instructions count: 558
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.oq6.c(sl4, java.lang.StringBuilder, int):void");
    }
}
