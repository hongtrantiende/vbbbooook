        ...
        if (i < size) {
            ...
            if (exchange != null) {
                if (exchange.c.b().c(request.a)) {
                    if (this.i != 1) {
                        jh1.h(arrayList.get(i - 1), " must call proceed() exactly once", "network interceptor ");
                        return null;
                    }
                } else {
                    jh1.h(arrayList.get(i - 1), " must retain the same host and port", "network interceptor ");
                    return null;
                }
            }
            int i2 = i + 1;
            ...
            Response p = interceptor.p(a);
            if (p != null) {
                if (exchange != null && i2 < arrayList.size() && a.i != 1) {
                    jh1.h(interceptor, " must call proceed() exactly once", "network interceptor ");
                    return null;
                }
                return p;
            }
