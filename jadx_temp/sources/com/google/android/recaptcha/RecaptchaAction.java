...
public final class RecaptchaAction {
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof RecaptchaAction) && sl5.h(this.action, ((RecaptchaAction) obj).action)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return d21.t(new StringBuilder("RecaptchaAction(action="), this.action, ")");
    }
    ...
    public /* synthetic */ RecaptchaAction(String str, ml2 ml2Var) {
        this(str);
    }
}
