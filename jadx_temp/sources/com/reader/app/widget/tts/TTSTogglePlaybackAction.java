...
public final class TTSTogglePlaybackAction implements h5, xt5 {
    public static final int $stable = 8;
    private final dz5 playerController$delegate = twd.j(z46.a, new um(this, 5));
    ...
    public Object onAction(Context context, pn4 pn4Var, n5 n5Var, qx1 qx1Var) {
        ...
        if (AndroidTextToSpeechService.Q && AndroidTextToSpeechService.R) {
            if (AndroidTextToSpeechService.Q) {
                jma jmaVar = tn3.a;
                tn3.a(g3b.a);
            }
        } else if (AndroidTextToSpeechService.Q) {
            jma jmaVar2 = tn3.a;
            tn3.a(h3b.a);
        } else {
            playerController.b();
