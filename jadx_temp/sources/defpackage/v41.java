...
public final class v41 {
    ...
    */
    public static int c(int r4, int r5, int r6, int r7) {
        /*
            r0 = 4
            defpackage.wpd.x(r4, r0)
            defpackage.wpd.x(r5, r0)
            defpackage.wpd.x(r6, r0)
            defpackage.wpd.x(r7, r0)
            r0 = 0
            r1 = 1
        ...
        L2e:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.v41.c(int, int, int, int):int");
    }
