    ...
    public static String a(int i) {
        ...
        if (map.containsKey(valueOf)) {
            ...
            if (map2.containsKey(valueOf)) {
                return jlb.x((String) map.get(valueOf), " (https://developer.android.com/google/play/integrity/reference/com/google/android/play/core/integrity/model/IntegrityErrorCode.html#", (String) map2.get(valueOf), ")");
            }
            return "";
        }
        return "";
