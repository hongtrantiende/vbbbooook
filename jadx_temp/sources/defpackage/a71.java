...
public final class a71 implements fs5 {
    public static final a71 a = new Object();
    public static final hi9 b = tbd.o("kotlin.collections.List<kotlin.CharSequence>", new fi9[0]);
    ...
    public final void b(uz8 uz8Var, List list) {
        ...
        if (uz8Var instanceof o79) {
            ...
            String str = o79Var.g;
            str.getClass();
            bundle.putCharSequenceArrayList(str, ct1.I(list));
            return;
        }
