...
.method public final a()Landroid/graphics/Canvas;
    ...
    .line 1
    iget-object p0, p0, Lhsa;->a:Landroid/graphics/Canvas;
    ...
    .line 7
    .line 8
    invoke-static {p0}, Log5;->d(Ljava/lang/String;)Ljava/lang/Void;
...
.method public final clipOutPath(Landroid/graphics/Path;)Z
    ...
    .line 1
    invoke-virtual {p0}, Lhsa;->a()Landroid/graphics/Canvas;
    ...
    .line 5
    invoke-static {p0, p1}, Lri5;->b(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final clipOutRect(FFFF)Z
    ...
    invoke-static {p0, p1, p2, p3, p4}, Lri5;->c(Landroid/graphics/Canvas;FFFF)Z
...
.method public final clipOutRect(IIII)Z
    ...
    invoke-static {p0, p1, p2, p3, p4}, Lri5;->d(Landroid/graphics/Canvas;IIII)Z
...
.method public final clipOutRect(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0, p1}, Lri5;->e(Landroid/graphics/Canvas;Landroid/graphics/Rect;)Z
...
.method public final clipOutRect(Landroid/graphics/RectF;)Z
    ...
    .line 5
    invoke-static {p0, p1}, Lri5;->f(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
...
.method public final disableZ()V
    ...
    .line 5
    invoke-static {p0}, Lef;->d(Landroid/graphics/Canvas;)V
...
.method public final drawColor(ILandroid/graphics/BlendMode;)V
    ...
    invoke-static {p0, p1, p2}, Lef;->e(Landroid/graphics/Canvas;ILandroid/graphics/BlendMode;)V
...
.method public final drawColor(J)V
    ...
    invoke-static {p0, p1, p2}, Lef;->f(Landroid/graphics/Canvas;J)V
...
.method public final drawColor(JLandroid/graphics/BlendMode;)V
    ...
    invoke-static {p0, p1, p2, p3}, Lef;->g(Landroid/graphics/Canvas;JLandroid/graphics/BlendMode;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    .line 5
    invoke-static/range {p0 .. p7}, Lef;->h(Landroid/graphics/Canvas;Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
    ...
    invoke-static/range {p0 .. p5}, Lef;->i(Landroid/graphics/Canvas;Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
...
.method public final drawGlyphs([II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
    ...
    .line 5
    invoke-static/range {p0 .. p7}, Ljh;->i(Landroid/graphics/Canvas;[II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
    ...
    .line 5
    invoke-static {p0, p1, p2, p3}, Ljh;->j(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    invoke-static {p0, p1, p2, p3}, Ljh;->k(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
...
.method public final drawRenderNode(Landroid/graphics/RenderNode;)V
    ...
    .line 5
    invoke-static {p0, p1}, Lef;->j(Landroid/graphics/Canvas;Landroid/graphics/RenderNode;)V
...
.method public final drawTextRun(Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
    ...
    .line 12
    invoke-static/range {p0 .. p9}, Lef;->k(Landroid/graphics/Canvas;Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
...
.method public final enableZ()V
    ...
    .line 5
    invoke-static {p0}, Lef;->l(Landroid/graphics/Canvas;)V
...
.method public final quickReject(FFFF)Z
    ...
    invoke-static {p0, p1, p2, p3, p4}, Lqt9;->p(Landroid/graphics/Canvas;FFFF)Z
...
.method public final quickReject(Landroid/graphics/Path;)Z
    ...
    invoke-static {p0, p1}, Lqt9;->q(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final quickReject(Landroid/graphics/RectF;)Z
    ...
    invoke-static {p0, p1}, Lqt9;->r(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
