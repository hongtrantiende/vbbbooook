        ...
        if (length != 0) {
            ...
            while (true) {
                ...
                if (i3 <= i) {
                    ...
                    StaticLayout a = ov.a(text, (Layout.Alignment) e(textView, Layout.Alignment.ALIGN_NORMAL, "getLayoutAlignment"), Math.round(rectF.right), maxLines, textView, this.h, this.k);
            ...
            ds.j("No available text sizes to choose from.");
            return 0;
        }
    }
