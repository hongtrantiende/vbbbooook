...
public class NativeSymbol extends ScriptableObject implements Symbol {
    ...
    public static void init(Context context, Scriptable scriptable, boolean z) {
        LambdaConstructor lambdaConstructor = new LambdaConstructor(scriptable, CLASS_NAME, 0, 1, new bd7(8));
        lambdaConstructor.setPrototypePropertyAttributes(7);
        lambdaConstructor.defineConstructorMethod(scriptable, "for", 1, new dd7(lambdaConstructor, 3), 2, 3);
        lambdaConstructor.defineConstructorMethod(scriptable, "keyFor", 1, new cd7(28), 2, 3);
        lambdaConstructor.definePrototypeMethod(scriptable, "toString", 0, new cd7(29), 2, 3);
        lambdaConstructor.definePrototypeMethod(scriptable, "valueOf", 0, new jd7(0), 2, 3);
        SymbolKey symbolKey = SymbolKey.TO_PRIMITIVE;
        lambdaConstructor.definePrototypeMethod(scriptable, symbolKey, 1, new jd7(0), 3, 3);
        SymbolKey symbolKey2 = SymbolKey.TO_STRING_TAG;
        lambdaConstructor.definePrototypeProperty(symbolKey2, CLASS_NAME, 3);
        lambdaConstructor.definePrototypeProperty(context, "description", new c1(7), 3);
    ...
    private static Object js_for(final Context context, final Scriptable scriptable, Object[] objArr, final LambdaConstructor lambdaConstructor) {
        ...
        return getGlobalMap(scriptable).computeIfAbsent(scriptRuntime, new java.util.function.Function() { // from class: kd7
