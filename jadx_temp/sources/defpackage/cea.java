...
public final class cea extends s57 implements gb3, zq1 {
    public cuc J;
    public mea K;
    public final vlb L;

    public cea(cuc cucVar, mea meaVar) {
        meaVar.getClass();
        this.J = cucVar;
        this.K = meaVar;
        vlb d = ged.d();
        ((Paint) d.b).setAntiAlias(false);
        this.L = d;
    }
    ...
    /* JADX WARN: Type inference failed for: r9v0, types: [java.lang.Object, wu8] */
    ...
    public final void P0(vx5 vx5Var) {
        ...
        boolean z2;
        vx5Var.a();
        long j = ((qj5) this.J.d.getValue()).a;
            ...
            if (((int) (f >> 32)) > 0 && ((int) (f & 4294967295L)) > 0) {
                ...
                if (list != null) {
                    ...
                    if (lj5Var != null) {
                        ...
                        ye6 ye6Var = this.K.f;
                        f91 f91Var = new f91(list, (Object) obj2, (Object) obj3, (Object) obj4, (Object) obj, this, 6);
                        ye6Var.getClass();
    ...
    public final boolean z1(x11 x11Var, zcb zcbVar) {
        lcb lcbVar = zcbVar.d;
        if (lcbVar != null) {
            if (lcbVar.b()) {
                lcbVar = null;
            ...
            if (lcbVar != null) {
                ...
                x11Var.a(ljVar, 0L, (bitmap.getHeight() & 4294967295L) | (width << 32), c0.d(), c0.c(), this.L);
                return true;
            }
            return false;
        }
