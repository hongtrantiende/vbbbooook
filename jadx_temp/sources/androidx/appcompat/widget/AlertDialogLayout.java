...
public class AlertDialogLayout extends a96 {
    ...
    */
    ...
    @Override // defpackage.a96, android.view.View
        ...
        if (mode2 != 1073741824) {
            ...
            while (i13 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) z86Var).width == -1) {
                        int i14 = ((LinearLayout.LayoutParams) z86Var).height;
                        ((LinearLayout.LayoutParams) z86Var).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, makeMeasureSpec2, 0, i12, 0);
                        ((LinearLayout.LayoutParams) z86Var).height = i14;
                    }
                }
                i13++;
