...
public final class qm4 {
    ...
    public qm4(String str, String str2, String str3, int i, String str4, String str5, String str6, String str7, int i2, boolean z, boolean z2, boolean z3, long j, long j2) {
        this.a = str;
        this.b = str2;
        this.c = str3;
        this.d = i;
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof qm4) {
                qm4 qm4Var = (qm4) obj;
                if (!this.a.equals(qm4Var.a) || !this.b.equals(qm4Var.b) || !this.c.equals(qm4Var.c) || this.d != qm4Var.d || !this.e.equals(qm4Var.e) || !this.f.equals(qm4Var.f) || !this.g.equals(qm4Var.g) || !this.h.equals(qm4Var.h) || this.i != qm4Var.i || this.j != qm4Var.j || this.k != qm4Var.k || this.l != qm4Var.l || this.m != qm4Var.m || this.n != qm4Var.n) {
                    return false;
                }
                return true;
            }
    ...
    public final String toString() {
        StringBuilder n = jlb.n("GetInstalledExtension(id=", this.a, ", name=", this.b, ", author=");
