...
public abstract class mq6 {
    ...
    public static void b(StringBuilder sb, int i, String str, Object obj) {
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                sb.append(": \"");
                my0 my0Var = my0.c;
                sb.append(c32.o(new my0(((String) obj).getBytes(kk5.a))));
                sb.append('\"');
            } else if (obj instanceof my0) {
                sb.append(": \"");
                sb.append(c32.o((my0) obj));
                sb.append('\"');
    ...
    */
    public static void c(defpackage.ql4 r21, java.lang.StringBuilder r22, int r23) {
        /*
            Method dump skipped, instructions count: 558
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.mq6.c(ql4, java.lang.StringBuilder, int):void");
    }
}
