...
public final class sf1 extends j61 {
    public int B;
    public int C;
    public int D;
    public int E;
    ...
    public sf1(InputStream inputStream) {
        super(3, (byte) 0);
    ...
    public final boolean x0(int i) {
        ...
        if (i3 > i4) {
            ...
            if (i <= (Integer.MAX_VALUE - i5) - i2 && i5 + i2 + i <= this.F) {
                ...
                int i6 = this.f;
                try {
                    int read = inputStream.read(bArr, i6, Math.min(bArr.length - i6, (Integer.MAX_VALUE - this.E) - i6));
                    if (read != 0 && read >= -1 && read <= bArr.length) {
                        ...
                        ds.f(read, inputStream.getClass());
                        return false;
                    }
                } catch (gm5 e) {
                    e.a = true;
    ...
    public final String z() {
        ...
        if (r0 > 0) {
            ...
            int i2 = this.C;
            if (r0 <= i - i2) {
                String str = new String(bArr, i2, r0, mk5.a);
                this.C += r0;
                return str;
            }
        }
        ...
        if (r0 >= 0) {
            if (r0 <= this.f) {
                v0(r0);
                String str2 = new String(bArr, this.C, r0, mk5.a);
                this.C += r0;
                return str2;
            }
            return new String(m0(r0), mk5.a);
        }
        throw gm5.d();
    }
}
