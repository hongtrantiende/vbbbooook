...
public final class eae extends i8d {
    private static final eae zzc;
    private static volatile f9d zzd;
    private int zze;

    /* JADX WARN: Type inference failed for: r0v0, types: [i8d, eae] */
    static {
        ?? i8dVar = new i8d();
        zzc = i8dVar;
        i8d.j(eae.class, i8dVar);
    }

    public static /* synthetic */ void u(eae eaeVar, int i) {
        eaeVar.zze = i;
    }
