...
# direct methods
.method public constructor <init>(Ltc2;Ljava/lang/String;JLxc2;)V
    .locals 1
    ...
    .line 17
    iput-object p1, p0, Lfd2;->e:Ltc2;

    invoke-direct {p0, p5}, Lvo8;-><init>(Lkotlin/jvm/functions/Function1;)V

    .line 18
    iput-object p2, p0, Lfd2;->c:Ljava/lang/String;
...
.method public constructor <init>(Ltc2;Ljava/lang/String;JLxc2;B)V
    .locals 0
...
.method public final b(Lkotlin/jvm/functions/Function1;)Lzo8;
    ...
    .line 55
    .line 56
    const-string v2, "SELECT DbBook.id, DbBook.name, DbBook.author, DbBook.cover, DbBook.type, DbBook.format, DbBook.category, DbBook.language, DbBook.pathId, DbBook.path, DbBook.source, DbBook.extensionId, DbBook.status, DbBook.location, DbBook.description, DbBook.isNsfw, DbBook.lastReadChapterName, DbBook.lastReadChapterId, DbBook.lastReadChapterIndex, DbBook.lastReadChapterPercent, DbBook.totalChapter, DbBook.totalReadTime, DbBook.totalListenedTime, DbBook.follow, DbBook.favorite, DbBook.hidden, DbBook.pined, DbBook.newUpdateCount, DbBook.translate, DbBook.extras, DbBook.readScore, DbBook.lastUpdate, DbBook.lastRead, DbBook.createAt, DbBook.updateAt\nFROM DbBook\nWHERE hidden = 0\n    AND (name LIKE (\'%\' || ? || \'%\')\n        OR author LIKE (\'%\' || ? || \'%\'))\nORDER BY lastRead DESC\nLIMIT ?"
...
.method public final toString()Ljava/lang/String;
    ...
    .line 5
    .line 6
    const-string p0, "DbBook.sq:getByCategoryPreview"
    ...
    .line 9
    :pswitch_0
    const-string p0, "DbBook.sq:find"
