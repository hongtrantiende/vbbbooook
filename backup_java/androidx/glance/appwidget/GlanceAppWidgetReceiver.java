...
public abstract class GlanceAppWidgetReceiver extends AppWidgetProvider {
    public final bp2 a = o23.a;

    public static final void a(GlanceAppWidgetReceiver glanceAppWidgetReceiver, t12 t12Var, Context context) {
        ixd.q(t12Var, null, null, new si3(context, glanceAppWidgetReceiver, (qx1) null, 18), 3);
    }

    public abstract woa b();

    @Override // android.appwidget.AppWidgetProvider
    public final void onAppWidgetOptionsChanged(Context context, AppWidgetManager appWidgetManager, int i, Bundle bundle) {
        ivd.Y(this, this.a, new nf(this, context, i, bundle, (qx1) null));
    }

    @Override // android.appwidget.AppWidgetProvider
    public final void onDeleted(Context context, int[] iArr) {
        ivd.Y(this, this.a, new on4(this, context, iArr, (qx1) null));
    }
    ...
    */
    public final void onReceive(android.content.Context r8, android.content.Intent r9) {
        ...
        L28:
            ...
            if (r4 == r1) goto L47
            bp2 r9 = r7.a     // Catch: java.lang.Throwable -> La6 java.util.concurrent.CancellationException -> Laf
            nf r1 = new nf     // Catch: java.lang.Throwable -> La6 java.util.concurrent.CancellationException -> Laf
            r6 = 0
            r2 = r7
            r3 = r8
            r1.<init>(r2, r3, r4, r5, r6)     // Catch: java.lang.Throwable -> La6 java.util.concurrent.CancellationException -> Laf
            defpackage.ivd.Y(r2, r9, r1)     // Catch: java.lang.Throwable -> La6 java.util.concurrent.CancellationException -> Laf
            return
        L47:
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] iArr) {
        ivd.Y(this, this.a, new l(this, context, iArr, (qx1) null, 24));
    }
}
