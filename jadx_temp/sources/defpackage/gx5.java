...
public final class gx5 {
    ...
    public gx5(CharSequence charSequence, TextPaint textPaint, int i) {
        this.a = charSequence;
        this.b = textPaint;
        this.c = i;
    }
    ...
    public final BoringLayout.Metrics a() {
        ...
        if (!this.g) {
            TextDirectionHeuristic b = gza.b(this.c);
            int i = Build.VERSION.SDK_INT;
            CharSequence charSequence = this.a;
            TextPaint textPaint = this.b;
            if (i >= 33) {
                metrics = o4.m(charSequence, textPaint, b);
    ...
    public final CharSequence b() {
        ...
        if (charSequence == null) {
            ...
            if (charSequence2 instanceof Spanned) {
                ...
                if (k3c.A(spanned, CharacterStyle.class)) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x004f, code lost:
        if (defpackage.k3c.A(r2, defpackage.x56.class) == false) goto L21;
     */
    /* JADX WARN: Code restructure failed: missing block: B:23:0x0057, code lost:
        if (r3.getLetterSpacing() == defpackage.ged.e) goto L23;
     */
    /*
    ...
    */
    public final float c() {
        ...
        L39:
            ...
            java.lang.Class<y56> r4 = defpackage.y56.class
            boolean r4 = defpackage.k3c.A(r2, r4)
            if (r4 != 0) goto L5a
            java.lang.Class<x56> r4 = defpackage.x56.class
            boolean r2 = defpackage.k3c.A(r2, r4)
            if (r2 != 0) goto L5a
        L51:
        ...
        L5d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.gx5.c():float");
    }
}
