...
public class Context implements Closeable {
    ...
    public static void checkLanguageVersion(int i) {
        ...
        ds.k(h12.g(i, "Bad language version: "));
    }
    ...
    public static void checkOptimizationLevel(int i) {
        ...
        ds.k(h12.g(i, "Optimization level outside [-1..9]: "));
    }
        ...
        if (context2 == null) {
            if (context == null) {
                ...
                if (context.enterCount == 0) {
                    ...
                    ds.j("factory.makeContext() returned Context instance already associated with some thread");
                    return null;
                }
            } else if (context.enterCount != 0) {
                ds.j("can not use Context instance already associated with some thread");
                return null;
            }
    ...
    public static void exit() {
        ...
        ds.j("Calling Context.exit without previous Context.enter");
    }
    ...
    public static Context getContext() {
        ...
        ed7.f("No Context associated with current Thread");
        return null;
    }
    ...
    private ScriptNode parse(String str, String str2, int i, CompilerEnvirons compilerEnvirons, ErrorReporter errorReporter, boolean z) {
        ...
        if (z && (parse.getFirstChild() == null || parse.getFirstChild().getType() != 122)) {
            ds.k(d21.r("compileFunction only accepts source with single JS function: ", str));
            return null;
        }
    ...
    public Object callFunctionWithContinuations(Callable callable, Scriptable scriptable, Object[] objArr) {
        if (callable instanceof InterpretedFunction) {
            ...
            ds.j("Cannot have any pending top calls when executing a script with continuations");
            return null;
        }
        ds.k("Function argument was not created by interpreted mode ");
        return null;
    }
    ...
    public Object compileImpl(Scriptable scriptable, String str, String str2, int i, Object obj, boolean z, Evaluator evaluator, ErrorReporter errorReporter, Consumer<CompilerEnvirons> consumer) {
        ...
        if (obj != null && getSecurityController() == null) {
            ds.k("securityDomain should be null if setSecurityController() was never called");
            return null;
        }
        if (scriptable == null) {
            z2 = true;
    ...
    public final String decompileFunction(Function function, int i) {
        ...
        return rs5.o("function ", function.getClassName(), "() {\n\t[native code]\n}\n");
    }
    ...
    public Object executeScriptWithContinuations(Script script, Scriptable scriptable) {
        ...
        ds.k("Script argument was not a script or was not created by interpreted mode ");
        return null;
    }
    ...
    public final void setMaximumInterpreterStackDepth(int i) {
        ...
        if (this.interpretedMode) {
            if (i >= 1) {
                ...
                ds.k("Cannot set maximumInterpreterStackDepth to less than 1");
                return;
            }
        }
        ds.j("Cannot set maximumInterpreterStackDepth outside interpreted mode");
    }
    ...
    public static Object call(ContextFactory contextFactory, Callable callable, Scriptable scriptable, Scriptable scriptable2, Object[] objArr) {
        ...
        return call(contextFactory, new mw1(callable, scriptable, scriptable2, objArr));
    }
