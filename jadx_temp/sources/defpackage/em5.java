...
public class em5 extends IOException {
    public boolean a;

    /* JADX WARN: Type inference failed for: r0v0, types: [java.io.IOException, em5] */
    public static em5 a() {
        return new IOException("Protocol message had invalid UTF-8.");
    }

    /* JADX WARN: Type inference failed for: r0v0, types: [java.io.IOException, bm5] */
    public static bm5 b() {
