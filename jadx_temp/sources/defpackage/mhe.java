...
public final class mhe extends i8d {
    private static final mhe zzc;
    private static volatile f9d zzd;
    private int zze;

    /* JADX WARN: Type inference failed for: r0v0, types: [i8d, mhe] */
    static {
        ?? i8dVar = new i8d();
        zzc = i8dVar;
        i8d.j(mhe.class, i8dVar);
    }

    public static /* synthetic */ void u(mhe mheVar, int i) {
        mheVar.zze = i;
    }
